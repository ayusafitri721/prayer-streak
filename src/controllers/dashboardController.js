...
async function renderDashboard(req, res) {
  ...
  try {
    ...
    return res.render("pages/dashboard", {
      ...
      sunnahChecklist: [
        { key: "qabliyah_subuh", label: "Qabliyah Subuh", time: "04:20", note: "Sebelum Subuh", isAvailable: true, isSunnah: true },
        { key: "dhuha", label: "Dhuha", time: "08:00", note: "Setelah matahari naik", isAvailable: true, isSunnah: true },
        { key: "ba_diyah_dzuhur", label: "Ba'diyah Dzuhur", time: "12:20", note: "Setelah Dzuhur", isAvailable: true, isSunnah: true },
        { key: "witir", label: "Witir", time: "20:15", note: "Setelah Isya", isAvailable: true, isSunnah: true },
        { key: "tahajud", label: "Tahajud", time: "03:30", note: "Sepertiga malam terakhir", isAvailable: true, isSunnah: true },
      ],
      todayState: {
        shubuh: null,
        dzuhur: null,
        ...
        qabliyah_subuh: null,
        dhuha: null,
        ba_diyah_dzuhur: null,
        witir: null,
        tahajud: null,
      },
      todaySunnahCompleted: 0,
      totalSunnahToday: 5,
